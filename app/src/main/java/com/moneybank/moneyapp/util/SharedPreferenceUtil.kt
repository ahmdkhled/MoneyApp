...
package com.moneybank.moneyapp.util
 ...
 * provide [fileName] of your shared preference whereas default value is \"moneybank-prefs\"
 * @author Rucha Bhatt
 * @version 1.0.0
 * @since 23-10-2019
 */
@JvmOverloads
fun Context?.getDefaultPreference(fileName: String? = "moneybank-prefs"): SharedPreferences? =
